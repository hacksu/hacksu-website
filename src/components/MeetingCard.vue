<template>
  <div
    ...
    :class="{ 'future-meeting': isFutureMeeting, 'past-meeting': isPastMeeting }"
  ...
  >
    ...
    <div class="event">
      ...
      >
        <img
          class="external-link"
          v-if="event.link && event.link.startsWith('https://github.com')"
          style="height: 30px"
      ...
      <div class="event-footer" v-else>
        ...
        <p style="text-align: right">
          Presented by <strong>{{ event.presenter }}</strong>
        </p>
      </div>
    </div>
  </div>
